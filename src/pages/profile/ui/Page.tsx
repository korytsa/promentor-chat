  ...
  return (
    <section className="flex min-h-0 flex-1 flex-col rounded-r-lg border border-white/20 p-6">
      <div className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        <article className="rounded-lg border border-white/20 bg-white/3 p-5">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-semibold text-[#eff5ff]">
              {profileHeadingTitle(profile, isOwnProfile)}
            </h1>
            <div className="flex items-center gap-2">
              <span className="rounded-lg border border-emerald-300/40 bg-emerald-400/10 px-3 py-1 text-xs font-medium text-green-300">
                MENTOR
              </span>
              {isOwnProfile && (
                <button
                  ...
                  className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg border border-[#4f80d6]/60 bg-[#1a2f5a]/70 px-3 py-1 text-xs font-medium text-[#d6e6ff] transition hover:bg-[#21407d]"
                >
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-green-600">{profile.statusLabel}</p>
            </div>
          </div>

          {isOwnProfile && (
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <div className="rounded-lg border border-white/20 bg-white/2 p-3">
        ...
        {isOwnProfile ? (
          <article className="rounded-lg border border-white/20 bg-white/3 p-5">
            ...
            <div className="mt-4 space-y-3">
              <div className="rounded-lg border border-white/20 bg-white/2 px-4 py-3">
          ...
          <article className="flex flex-col justify-between">
            <div className="rounded-lg h-full border border-white/20 bg-white/3 p-5">
              <h2 className="text-sm font-semibold uppercase tracking-[0.08em] text-[#9bb4df]">
                Contact
              </h2>
      ...
      <article className="mt-4 rounded-lg border border-white/20 bg-white/3 p-5">
